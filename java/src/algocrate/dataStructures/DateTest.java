...
public class DateTest {
    ...
    public void testLeapYearNextDay() {
        ...
        assertEquals(leapDay.next().toString(), "02/29/2024");

        Date nonLeapDay = new Date(2, 28, 2023); // Not a leap year
        assertEquals(nonLeapDay.next().toString(), "03/01/2023");
    }
    ...
    public void testNextDate() {
        ...
        assertEquals(next1.toString(), "01/01/2024"); // Should be Jan 1, 2024

        Date date2 = new Date(2, 28, 2024); // Leap year
        Date next2 = date2.next();
        assertEquals(next2.toString(), "02/29/2024");

        Date date3 = new Date(2, 28, 2023); // Non-leap year
        Date next3 = date3.next();
        assertEquals(next3.toString(), "03/01/2023");
    }
    ...
    public void testToStringFormat() {
        ...
        assertEquals(date.toString(), "04/05/2023");
    }
}
