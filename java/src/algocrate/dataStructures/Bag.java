...
public class Bag<Item> implements Iterable<Item> {
	...
	/*
	 * Returns an interator that interates over the items in this bag in arbitrary order.
	 * Since it's being implemented using a LinkedList, the iterator order should be reverse of addition to the bag
	 */
