...
public interface OrderedST<Key extends Comparable<Key>, Value> {
	...
	default void deleteMin() { delete(min()); }						// delete smallest key
	default void deleteMax()  {	delete(max()); }					// delete largest key
	...
	default Iterable<Key> keys() {	return keys(min(), max()); }	// all keys in the table, in sorted order	
}